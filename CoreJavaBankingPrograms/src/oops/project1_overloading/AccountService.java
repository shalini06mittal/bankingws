...
public class AccountService {
    ...
    public boolean deposit(int accountNumber, double amount) throws AccountNotFoundException, InactiveAccountException {
        if (amount <= 0) {
        ...
        if (!account.isActive()) {
            throw new InactiveAccountException("Account is inactive for account "+accountNumber);
        }
    ...
    public boolean withdraw(int accountNumber, double amount) throws AccountNotFoundException, InactiveAccountException, InsufficientBalanceException {

        return withdraw(accountNumber, amount, false);
    }

    // Method 2: With overdraft allowed
    public boolean withdraw(int accountNumber, double amount, boolean allowOverdraft) throws AccountNotFoundException, InactiveAccountException, InsufficientBalanceException {
        if (amount <= 0) {
        ...
        double overdraftLimit = allowOverdraft ? 500.0 : 0.0;
        ...
        System.out.printf("Withdrawn $%.2f. Remaining balance: $%.2f%n", amount, newBalance);
        return true;
    }
    ...
    public boolean transfer(int fromAccount, int toAccount, double amount) throws InactiveAccountException, InsufficientBalanceException, AccountNotFoundException {
    ...
    public void displayAllAccounts() {
        ...
        for (BankAccount account : allAccounts) {
            ...
            System.out.printf("%d\t%-20s\t%-10s\t$%.2f\t\t%s%n",
