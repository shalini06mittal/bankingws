...
public class AccountService {
    ...
    public boolean deposit(int accountNumber, double amount) throws AccountNotFoundException {
        if (amount <= 0) {
    ...
    public boolean withdraw(int accountNumber, double amount) throws AccountNotFoundException, InsufficientBalanceException {
        if (amount <= 0) {
    ...
    public boolean transfer(int fromAccount, int toAccount, double amount) throws InsufficientBalanceException, AccountNotFoundException {
