package oops.project1_inheritance;
...
public class BankingApplication {
    public static void main(String[] args) {
        ...
        BankAccount savings = new SavingsAccount(3001, "Alice Johnson", 5000, 0.04);
        System.out.println();
        ...
        BankAccount fd = new FixedDepositAccount(3003, "Charlie Brown", 10000, 0.07, 12);
        System.out.println();
